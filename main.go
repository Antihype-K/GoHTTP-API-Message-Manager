...
func deleteHandler(w http.ResponseWriter, r *http.Request) {
	if r.Method == "DELETE" {
		...
		w.Write([]byte("Неправильный метод, воспользуйтесь DELETE"))
	}
...
func addHandler(w http.ResponseWriter, r *http.Request) {
	if r.Method == "POST" {
		...
		w.WriteHeader(http.StatusMethodNotAllowed)
		w.Write([]byte("Неправильный метод, воспользуйтесь POST"))
	}
}
...
func printHandler(w http.ResponseWriter, r *http.Request) {
	if r.Method == "GET" {
		...
		w.WriteHeader(http.StatusMethodNotAllowed)
		w.Write([]byte("Неправильный метод, воспользуйтесь GET"))
	}
}
